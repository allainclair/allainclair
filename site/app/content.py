...
def get_telnyx_content(user_language: str) -> list[str]:
	return [
		Div(i18n("• Enabled our customers to monitor and manage thousands of SMS messages daily.", user_language)),
...
def get_necc_content(user_language: str):
	return [
		Div(i18n("• Designed and maintained education-tech apps, adding and improving features to make teachers and students have modern and faster apps: improved page load by 200%.", user_language)),
		Div(i18n("• Worked on migrating one Java monolith app, breaking it into some Python microservices.", user_language)),
	]
